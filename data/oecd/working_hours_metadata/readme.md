...
This data package contains the data that powers the chart ["Annual working hours per person employed"](https://ourworldindata.org/grapher/annual-working-hours-per-person-employed?country=USA~European+Union+%2828+countries%29~DEU~FRA~ITA~ESP&v=1&csvType=filtered&useColumnShortNames=false) on the Our World in Data website. It was downloaded on March 04, 2026.

### Active Filters

A filtered subset of the full data was downloaded. The following filters were applied:
- country: USA, European Union (28 countries), DEU, FRA, ITA, ESP
